...
def generate(
        ...
        sampler_name="ddpm",
        n_inference_steps=50,  # noice encode and decode steps
    ...
    if input_image:
        ...
        # (Batch_Size, 4, Latents_Height, Latents_Width)
        # If text to image -> start with random noice level N(0,I)
...
def get_time_embedding(timestep):
    # Shape: (160,)
    freqs = torch.pow(10000, -torch.arange(start=0, end=160, dtype=torch.float32) / 160) #positional encoding
    # Shape: (1, 160)
